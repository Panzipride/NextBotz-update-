...
I'm AtsairBotz Yang Di Buat Gak Niat Oleh Atsaiir kul karena males recode jadi Pake aja yang ada.
Kalau Ada Yg Error Bisa Langsung Report Ke Owner.\n`,wm + '\n\n' + botdate, thumbdoc, [['Aʟʟ Mᴇɴᴜ','.? all'],['Lɪsᴛ Mᴇɴᴜ','.siuuu']], m, {
contextInfo: { externalAdReply :{
                        mediaUrl: '',
                        mediaType: 2,
                        description: 'anu',
                        title: `A ATSAIR🎧 : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`,
